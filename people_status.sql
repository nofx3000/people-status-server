...
INSERT INTO `Records` (`id`, `person_id`, `problem_id`, `createdAt`, `updatedAt`, `is_closed`, `updated_bar`) VALUES (90, 6, 2, '2024-12-16 10:59:32', '2024-12-16 10:59:32', 0, NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `Units` (`id`, `name`, `isCommand`) VALUES (1, '1单位', 0);
INSERT INTO `Units` (`id`, `name`, `isCommand`) VALUES (2, '2单位', 0);
INSERT INTO `Units` (`id`, `name`, `isCommand`) VALUES (3, '3单位', 0);
